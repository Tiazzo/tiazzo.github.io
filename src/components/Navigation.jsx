...
export default function Navigation({activeSection}) {
    ...
    return (<>
            ...
            {/* Contacts*/}
                ...
                {/* Sidebar desktop */}
                <aside
                    className="hidden lg:flex fixed top-0 left-0 h-screen w-1/2 flex-col items-center justify-between p-8 bg-base-100 backdrop-blur z-50">
                    ...
                    <div className="w-full max-w-xs flex flex-col items-start pt-32">
                        ...
                        <p className="text-2xl font-semibold mb-20 text-base-content/70">Computer Engineer Student</p>
                    ...
                    <div className="mt-auto mb-25 w-full max-w-xs px-1">
                        <div className="flex justify-between items-center text-2xl text-base-content/60">
